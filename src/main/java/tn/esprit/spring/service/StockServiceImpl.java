...
// you can test with this :
	...
	@Override
	public List<Stock> retrievestockparidstockdeproduit(Long yes,String libp) {
		return stockrepository.retrievestockparidstockdeproduit(yes,libp);
	}

	@Override
	public List <Fournisseurprod> retrievefournisseurandlibprodparstock(Long test) {
		return stockrepository.retrievefournisseurandlibprodparstock(test);
		// TODO Auto-generated method stub
	}

	@Override
	public List<Stock> retrieveqtestockandqtemin() {
		// TODO Auto-generated method stub
		
		return stockrepository.retrieveqtestockandqtemin();
	}
